...
from grasping_benchmarks_ros.srv import GraspPlannerImageAndCloud
...
class GraspnetGraspPlannerService(GraspnetGraspPlanner):
    def __init__(self, grasp_offset, cv_bridge, grasp_service_name, grasp_publisher_name):
        """
        Parameters
        ----------
        ...
        super(GraspnetGraspPlannerService, self).__init__( grasp_offset)
        ...
        self._grasp_planning_service = rospy.Service(grasp_service_name, GraspPlannerImageAndCloud,
    ...
    def read_images(self, req):
        ...
        #edit point cloud format

        assert isinstance(req.cloud, PointCloud2)
        gen = point_cloud2.read_points_list(req.cloud, skip_nans=True)
...
if __name__ == "__main__":
    ...
    grasp_planner = GraspnetGraspPlannerService( grasp_offset, cv_bridge,
